    ...
    IServiceProvider serviceProvider)
{
    ...
    try
    {
        ...
        var response = await httpClient.GetAsync($"{apiBaseUrl}/api/transactions?limit=10");
    ...
    IServiceProvider serviceProvider)
{
    ...
    try
    {
        ...
        var response = await httpClient.GetAsync(
            $"{apiBaseUrl}/api/transactions/summary?account={encodedAccount}");
...
- **URL encoding**: `Uri.EscapeDataString()` handles account names with spaces
